...
func _ready() -> void:
	if OS.has_feature("web"):
		var base_path: String = video_path.get_base_dir()
		var base_filename: String = video_path.get_basename()
		var fallback_path: String = base_path.path_join(base_path + ".ogv")
